    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          ...
          <el-form-item label="级别" prop="hospitalLevel">
            <el-select
          ...
          <el-form-item label="地区" prop="reginArea">
            <el-select
              v-model="queryParams.reginArea"
              placeholder="地区"
              clearable
              style="width: 240px"
            >
              <el-option
                v-for="dict in dict.type.regin_area"
                :key="dict.value"
                :label="dict.label"
                :value="dict.value"
              />
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="地区" align="center" key="reginArea" prop="reginArea"  v-if="columns[4].visible"></el-table-column>
          <el-table-column label="级别" align="center" key="hospitalLevel" prop="hospitalLevel"  v-if="columns[4].visible"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="级别" prop="hospitalLevel">
              <el-select v-model="form.hospitalLevel" placeholder="请选择级别">
                <el-option
                  v-for="d in dict.type.hospital_level"
                  :key="d.value"
                  :label="d.label"
                  :value="d.value"
                ></el-option>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="地区" prop="reginArea">
              <el-select v-model="form.reginArea" placeholder="请选择地区">
                <el-option
                  v-for="dict in dict.type.regin_area"
                  :key="dict.value"
                  :label="dict.label"
...
export default {
  name: "User",
  dicts: ['sys_normal_disable', 'sys_user_sex', 'hospital_level', 'regin_area'],
  ...
  methods: {
    ...
    handleExport(row) {
      const userIds = row.userId || this.ids;
      this.queryParams.ids = userIds.toString()
